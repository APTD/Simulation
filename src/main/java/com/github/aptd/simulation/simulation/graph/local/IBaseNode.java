 ...
 * @tparam T node type
 */
public abstract class IBaseNode<T> extends IBaseAgent<INetworkNode<T>> implements INetworkNode<T>
{
    /**
     * node identifier
     */
     ...
     */
    public IBaseNode( final IAgentConfiguration<INetworkNode<T>> p_configuration, final T p_id, final double p_longitude, final double p_latitude )
    {
