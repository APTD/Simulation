 ...
 * enum with activies
 */
public enum EEvent implements IEdge<IActivity<ITrain, IStation<?>, EEvent>>
{
    ARRIVAL,
    DEPATURE,
    CHANGE;
            ...
            @Override
            public IActivity<ITrain, IStation<?>, EEvent> from()
            {
                return null;
            }

            @Override
            public IActivity<ITrain, IStation<?>, EEvent> to()
    {
    return null;
    }
